...
void main(void)
{
    ...
    tableau_ecriture[0]=0x0E;
    tableau_ecriture[1]=0xCD;
    ...
    tableau_lecture[0]=0x0E;
    tableau_lecture[1]=0xCD;
    while (1)
    {
# 55 "main.c"
        while(I2C_Open(0x50) == I2C_BUSY);
        I2C_SetBuffer(tableau_ecriture,6);
        ...
        while(I2C_Open(0x50) == I2C_BUSY);
        I2C_SetBuffer(tableau_ecriture, 2);
        I2C_MasterOperation(0);
